...
/**
 * Foundation6WidgetTrait is the trait, which provides basic for all foundation6 widgets features.
 *
...
trait Foundation6WidgetTrait
{
    ...
    protected function registerPlugin($name)
    {
        ...
        Foundation6PluginAsset::register($view);
